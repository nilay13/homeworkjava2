...
public class KPSPublicSoapProxy implements homeworkjava2.tr.gov.nvi.tckimlik.WS.KPSPublicSoap {
  private String _endpoint = null;
  private homeworkjava2.tr.gov.nvi.tckimlik.WS.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new homeworkjava2.tr.gov.nvi.tckimlik.WS.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public homeworkjava2.tr.gov.nvi.tckimlik.WS.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
