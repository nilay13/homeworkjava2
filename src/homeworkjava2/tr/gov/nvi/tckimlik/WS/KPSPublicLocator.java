...
package homeworkjava2.tr.gov.nvi.tckimlik.WS;

public class KPSPublicLocator extends org.apache.axis.client.Service implements homeworkjava2.tr.gov.nvi.tckimlik.WS.KPSPublic {
    ...
    public homeworkjava2.tr.gov.nvi.tckimlik.WS.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public homeworkjava2.tr.gov.nvi.tckimlik.WS.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            homeworkjava2.tr.gov.nvi.tckimlik.WS.KPSPublicSoapStub _stub = new homeworkjava2.tr.gov.nvi.tckimlik.WS.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (homeworkjava2.tr.gov.nvi.tckimlik.WS.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                homeworkjava2.tr.gov.nvi.tckimlik.WS.KPSPublicSoapStub _stub = new homeworkjava2.tr.gov.nvi.tckimlik.WS.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
